...
public class Menu {
    ...
    /**
     * get() gets the option with the specified index
     *
     * @param index index
    ...
    /**
     * remove() removes an option from the list
     *
     * @param option option
    ...
    /**
     * remove() removes an option (given its position) from the list
     *
     * @param index index
    ...
    /**
     * choose() gets input from user to select an option if error, it returns de
     * default value -1
     *
